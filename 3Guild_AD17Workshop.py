### IWA AD17 Modeling Example###
#This model is a demonstration model containing 3 microbial guilds:
#GFOs = Glucose Fermenting Organisms which ferment glucose to acetate and H2
#AMAs = Acetoclastic methanogenic archaea
#HMAs = Hydrogenotrophic methanogenic archaea which convert H2 and CO2 to methane
#The default objective function is to maximize production of TOTAL biomass in the microbial community
...
###SECTION 2: ADD METABOBILTES AND REACTIONS FOR ALL GUILDS (This is a very long section)
...
###SECTION 3: Define model constraints (media, reaction knockouts, objective function, etc.)
